defmodule GSGMS.Accounts.RolesTest do
  use GSGMS.DataCase

  alias GSGMS.Accounts.Roles

  describe "roles" do
    alias GSGMS.Accounts.Roles.Role

    @valid_attrs %{name: "some name", premissions: %{}}
    @update_attrs %{name: "some updated name", premissions: %{}}
    @invalid_attrs %{name: nil, premissions: nil}
