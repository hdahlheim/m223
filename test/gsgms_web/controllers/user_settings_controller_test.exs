defmodule GSGMSWeb.UserSettingsControllerTest do
  use GSGMSWeb.ConnCase, async: true

  alias GSGMS.Accounts.Users
  import GSGMS.Accounts.UsersFixtures
  ...
  describe "PUT /account/settings/update_password" do
    test "updates the user password and resets tokens", %{conn: conn, user: user} do
      ...
      assert redirected_to(new_password_conn) == "/account/settings"
  ...
  describe "PUT /account/settings/update_email" do
    @tag :capture_log
  ...
  describe "GET /account/settings/confirm_email/:token" do
    setup %{user: user} do
